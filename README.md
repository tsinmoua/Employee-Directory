...
## Description 
Too many employees to remember all their information? With this application their information is readily available at your fingertips. See your employee's first, last name, phone number, email address, and date of birth. 
...
## Usage Information
If using [Heroku](https://desolate-ocean-52390.herokuapp.com/), just start searching the directory and sorting. If not, use the following command
```
npm start
```
![Demo](./public/assets/images/Employee-Directory-Demo.gif)
